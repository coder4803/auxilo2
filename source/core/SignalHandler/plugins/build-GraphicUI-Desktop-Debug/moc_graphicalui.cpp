/****************************************************************************
** Meta object code from reading C++ file 'graphicalui.hh'
**
...
#include "../GraphicUI/graphicalui.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'graphicalui.hh' doesn't include <QObject>."
...
static const qt_meta_stringdata_GraphicalUI_t qt_meta_stringdata_GraphicalUI = {
    {
QT_MOC_LITERAL(0, 0, 11), // "GraphicalUI"
QT_MOC_LITERAL(1, 12, 16), // "onQuitBtnClicked"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "GraphicalUI\0onQuitBtnClicked\0"
};
...
void GraphicalUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onQuitBtnClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GraphicalUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GraphicalUI.data,
      qt_meta_data_GraphicalUI,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GraphicalUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SignalHandler::ViewInterface"))
        return static_cast< SignalHandler::ViewInterface*>(const_cast< GraphicalUI*>(this));
